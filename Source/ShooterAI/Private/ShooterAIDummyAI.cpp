...
AShooterAIDummyAI::AShooterAIDummyAI()
{
...
void AShooterAIDummyAI::BeginPlay()
{
    Super::BeginPlay();
...
void AShooterAIDummyAI::MoveForward(float Value)
{
    if (Value != 0.0f)
    {
...
void AShooterAIDummyAI::MoveRight(float Value)
{
    if (Value != 0.0f)
    {
        // add movement in that direction
...
void AShooterAIDummyAI::TurnAtRate(float Rate)
{
    // calculate delta for this frame from the rate information
    AddControllerYawInput(Rate * BaseTurnRate * GetWorld()->GetDeltaSeconds());
}

void AShooterAIDummyAI::LookUpAtRate(float Rate)
{
    // calculate delta for this frame from the rate information
